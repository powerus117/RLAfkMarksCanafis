...
enum Courses {
    ...
    // Other courses
    GNOME(23139, 9781, new WorldPoint(2484, 3437, 0), new WorldPoint(2487, 3437, 0)), // Gnome course has 2 last obstacles but we just use one TODO: figure out a way to handle multiple last obstacles better
